...
export default function Contact() {
  ...
  return (
    ...
    viewport={{
        ...
        <p className='text-gray-700 -mt-6 dark:text-white/80'>Feel free to contact me directly <a href="mailto:alielbasuony22@gmail.com" className='underline'>here</a> or through this form.</p>
